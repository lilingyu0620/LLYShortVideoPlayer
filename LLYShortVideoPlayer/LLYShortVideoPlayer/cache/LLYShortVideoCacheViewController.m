//
//  LLYShortVideoCacheViewController.m
//  LLYShortVideoPlayer
//
...
@interface LLYShortVideoCacheViewController ()<UICollectionViewDelegateFlowLayout,UICollectionViewDelegate,UICollectionViewDataSource>

@property (nonatomic, strong) UICollectionView *mCollectionView;
@property (nonatomic, strong) NSMutableArray *dataSourceArray;

@property (nonatomic, strong) LLYCacheCollectionViewCell *curVisibleCell;
@property (nonatomic, strong) LLYCacheCollectionViewCell *lastVisibleCell;

@property (nonatomic, strong) UIButton *backBtn;

@end

@implementation LLYShortVideoCacheViewController
...
- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView{
    ...
    self.curVisibleCell = (LLYCacheCollectionViewCell *)[self.mCollectionView cellForItemAtIndexPath:[NSIndexPath indexPathForRow:yIdx inSection:0]];
...
- (UICollectionView *)mCollectionView{
    if (!_mCollectionView) {
        ...
        [_mCollectionView registerClass:[LLYCacheCollectionViewCell class] forCellWithReuseIdentifier:@"LLYCacheCollectionViewCell"];
    }
